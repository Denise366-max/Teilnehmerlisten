...
# 1. Definiere User mit Klartext-Passwörtern
users = {
...
# 2. Hash die Klartext-Passwörter (nur einmal nötig, kann auch vorher gemacht und gespeichert werden)
hashed_passwords = stauth.Hasher(clear_passwords).generate()

# 3. Erstelle den Authenticator mit expliziten Parametern
